...
function SampleSpecialization.registerEventListeners(vehicleType)
	print("-- TelemetryPlugin: SampleSpecialization:registerEventListeners")
...
function SampleSpecialization:onPreLoad(savegame)
	print("-- TelemetryPlugin: Calling SampleSpecialization:onPreLoad function in vehicle")
	print("-- TelemetryPlugin: global text: " .. g_i18n:getText("GLOBAL_TEXT_1"))
end
...
function SampleSpecialization:onLoad(savegame)
	...
	print("-- TelemetryPlugin: self.spec_SampleSpecialization " .. tostring(self.spec_SampleSpecialization))
end